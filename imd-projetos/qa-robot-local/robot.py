...
if os.path.isdir (path):
    ...
    if os.listdir(path) == []:
        ...
        print("EXISTEM arquivos .png gerados pelo Robot no diretorio" +" "+ path +".")
        print("--")
        print("Compactando arquivos para enviar por email.")
        os.system("tar zcf /root/robot/log_robot_" +""+ date +""+".tar.gz "+ path +"")
        print("--")
        sleep(2)
